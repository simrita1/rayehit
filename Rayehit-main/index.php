            ...
            <div class="row cards">
                ...
                <div onclick="window.open('./sellerdb.php','_self')" class="card">
                    ...
                    <div class="des">
                        ...
                        <div class="card-body kregular">
                        No matter what path you take to sell your homw, we can help you navigate a successful sale.
                        </div>
                    </div>
                </div>
                <div onclick="window.open('./explore.php','_self')" class="card">
                    ...
                    <div class="des">
                        ...
                        <div class="card-body kregular">
                        We're creating a seamless online experience from shopping in the largest rental network, to applying, to paying rent.
                        </div>
                    </div>
                </div>
            </div>

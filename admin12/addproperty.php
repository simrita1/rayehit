        ...
        <section class="form">
            ...
            <form enctype="multipart/form-data" autocomplete="off" action="list.php" method="POST">
                <div class="inputgroup kregular">
                    ...
                    <br>
                    <input required name="title" placeholder="e.g. House for sell in Kathmandu" class="inputbottom kbold" type="text">
                </div>
                <div class="inputgroup kregular">
                    <label>
                        Property Image
                ...
                <div class="inputgroup kregular">
                    ...
                    <br>
                    <input required name="location" placeholder="e.g. Sorhakhutte, Kathmandu" class="inputbottom kbold" type="text">
                </div>
                <div class="inputgroup kregular">
                    <label>Number of bedroom</label>
                    <input required type="number" placeholder="e.g. 5" min="0" class="kbold inputbottom" name="bed" id="">
                </div>
                <div class="inputgroup kregular">
                    <label>Number of bathroom</label>
                    <input required placeholder="e.g. 2" type="number" min="0" class="kbold inputbottom" name="bath" id="">
                </div>
                <div class="inputgroup kregular">
                    <label>Total Area
                        (Aana)
                    </label>
                    <input required type="number" min="1" placeholder="e.g. 4" class="inputbottom kbold" name="area" id="">
                </div>
